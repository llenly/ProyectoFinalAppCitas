...
{{-- session para el titulo de la pagina dinamicos cada ves que abra la pagina sale el titulo de cada una --}}
            ...
            <div class="col-lg-5 col-md-7">
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        @else
                            <div class="text-center text-muted mb-4">
                                <h4>Registrate con tus creadenciales</h4>
                            </div>
                        @endif
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-6 text-right">
                        <a href="{{ route('register') }}" class="text-light"><small>Crear cuenta
                                nueva</small></a>
                    </div>
                </div>
            </div>
